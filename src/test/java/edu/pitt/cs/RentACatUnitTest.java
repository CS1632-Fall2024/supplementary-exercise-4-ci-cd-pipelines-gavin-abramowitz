...
public class RentACatUnitTest {
	...
	public void testListCatsNumCats3() {
		...
		r.addCat(c2);
		r.addCat(c3);
		// Mockito.when(r.listCats()).thenReturn("");
	...
	public void testRenameFailureNumCats0() {
		...
		Mockito.when(c1.toString()).thenReturn("Invalid cat ID." + System.lineSeparator());
		assertEquals("Invalid cat ID." + System.lineSeparator(), c1.toString());
	...
	public void testRenameNumCat3() {
		...
		r.addCat(c2);
		r.addCat(c3);
		Mockito.when(c1.toString()).thenReturn("Garfield");
		assertTrue(r.renameCat(2, "Garfield"));
		assertEquals("Garfield", c1.toString());
	}
	...
	public void testRentCatNumCats3() {
		...
		Mockito.when(c1.toString()).thenReturn("Old Deuteronomy has been rented." + System.lineSeparator());
		assertEquals("Old Deuteronomy has been rented." + System.lineSeparator(), c1.toString());
	...
	public void testRentCatFailureNumCats3() {
		...
		Mockito.when(c1.toString()).thenReturn("Sorry, Old Deuteronomy is not here!" + System.lineSeparator());
		r.rentCat(2);
		assertFalse(r.rentCat(2));
		assertEquals("Sorry, Old Deuteronomy is not here!" + System.lineSeparator(), c1.toString());
	}
	...
	public void testReturnCatNumCats3() {
		...
		r.addCat(c3);
		Mockito.when(c2.getRented()).thenReturn(true);
		Mockito.when(c1.toString()).thenReturn("Welcome back, Old Deuteronomy!" + System.lineSeparator());
		assertTrue(r.returnCat(2));
		assertEquals("Welcome back, Old Deuteronomy!" + System.lineSeparator(), c1.toString());
	}
	...
	public void testReturnFailureCatNumCats3() {
		...
		Mockito.when(c1.toString()).thenReturn("Old Deuteronomy is already here!" + System.lineSeparator());
		assertEquals("Old Deuteronomy is already here!" + System.lineSeparator(), c1.toString());
	}
